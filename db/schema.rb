...
ActiveRecord::Schema.define(:version => 20120528212305) do
  ...
  add_index "photos", ["spot_id"], :name => "index_pictures_on_spot_id"
  add_index "photos", ["user_id"], :name => "index_pictures_on_user_id"
